...
const Footer = () => {
  return (
    <footer className="bg-gray-800 fixed bottom-0 w-full text-sm text-gray-300 py-2 px-4 flex flex-col md:flex-row items-center justify-center space-y-2 md:space-y-0 md:space-x-4">
      <span className="flex items-center space-x-1">
        ...
        <a
          ...
          target="__blank"
          className="text-cyan-300 hover:text-white font-medium transition"
        >
          Manu Arora.
        </a>
      </span>
